...
public class FabricarPost {

	private static FabricarPost instance;

	public static synchronized FabricarPost getInstance() {
		if (instance == null)
			instance = new FabricarPost();
		return instance;
	}
	...
	public Post construirPost(String mensagem, String dataHora)
		...
		try {
			...
			if (mensagem.contains("#")) {
				...
				return new Post(construirConteudo(texto, midias),
						construirHashTags(hashTags), buildDate(dataHora),
						buildTime(dataHora));
			} else {
